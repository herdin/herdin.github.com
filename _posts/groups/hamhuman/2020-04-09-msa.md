...
* EC2 준비
  ...
  * 기다리는 동안 [여기 old](https://herdin.github.io/2020/04/13/aws-init)
    [여기 new]({% link _posts/2020/04/2020-04-13-aws-init.md %})를 보면서 아까 다운로드 받은 `.pem` 파일을 putty 에서 사용할 수 있도록 `.ppk` 파일로 변환해놓자.
* docker 설치 및 설정
